...
<title>文字表白网页_表白网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="<?php echo htmlspecialchars(urldecode($title)); ?>是一款全自动在线网页制作工具，飘散的文字表白，国内顶尖自动化网页制作系统，只需选择模板一键生成即可。可制作一系列个人网页、表白网页、HTML5网页等等，人人都能做网页。" />
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">漂浮的文字表白网页</h2>
            <h3 class="animate-box"><a href="../web.php?id=ql70DzP" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <textarea id="con3" name="con3" type="text" class="form-control textarea" rows="5" placeholder="请输入表白内容"></textarea>
        </div>
      </div>
	...
	<script>
        function shuru(){
            ...
            con3.value='当你需要我的时候，我都会在这里；当你有麻烦的时候，我都会在你身边；当你觉得孤独的时候；当你认为所有的人都已绝望；到我这里来，我会给你所有的爱。可能遇见你，对我来说是最大的幸福。有了你，我的生涯变的无穷广阔，有了你，世界变得如斯迷人。你是世界，世界是你。我乐意用本人的心，好好的陪着你，爱着你。陪你到你想去的处所，居心走完咱们人生的余下的旅程。在将来的日子里，兴许什么都无奈断定，但独一能够肯定的是，我爱的人是你，无论当初仍是未来，我想我这里都会是你最暖和的港湾，都是为你遮风避雨的城墙。你悄悄为我做的一切，天地知晓，我知晓！为这悄悄柔柔的温情，在滚滚红尘，我不怕红颜老褪，总在期待中度过慢慢长夜，可不后悔。让我陪着你，上天送厚礼，没有华丽的言语，表达真挚的情谊，只有一颗心，永恒为你跳起，那是我真实的感受，无论白天黑夜时刻牵挂着你,我爱你。';
          
			con5.value='我也爱你';
			con6.value='http://t.448521.com/?dd';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
