    ...
    <div class="form-group">
      <div class="page-header">
		...
		<form action="pingbi.php" method="post">
      	...
      	<form action="pingbi.php" method="post">
			...
			<div class="form-group">
			  <label>要屏蔽网页地址：</label>
			  <div class="form-group">
				  <input  type="text" name="url" class="form-control" placeholder="如：http://love.xfgod.cn/web.php?id=XXXXXXX" value="" required>
		...
		<form action="pingbi.php" method="post">
              ...
              <label>取消网页屏蔽：</label>
              <div class="form-group">
                <input id="deluser" type="text" name="url" class="form-control" placeholder="如：http://love.xfgod.cn/web.php?id=XXXXXXX" value="" required>
...
<div class="panel panel-info">
  ...
  <div class="panel-body"> 本后台由小风开发，可管理网站会员、网页屏蔽以及修改前台信息等等。若还想修改其他内容请直接修改前台代码，如果不了解请别动代码，以免程序出错。</div>
</div>
