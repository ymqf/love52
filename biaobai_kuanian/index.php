...
<title>跨年表白_<?php echo htmlspecialchars(urldecode($title)); ?></title>
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">跨年表白页面</h2>
            <h3 class="animate-box"><a href="../web.php?id=GSto6kr" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../../result.php">
	  ...
	  <div class="col-md-12">
        ...
        <div class="col-md-12">
        <div class="form-group">
          <textarea id="con3" name="con3" type="text" class="form-control textarea" rows="3" placeholder="请输入后最后的一段话"></textarea>
        </div>
      </div>
	...
	<script>
        function shuru(){
			...
			con1.value='2021我们一起跨年❤';
            con2.value='往事清零爱恨随意，2021希望你活的开心，不用回头不再将就，过去所有的遗憾都是2021的惊喜，遇见你都是天意，拥有你都是幸运2021，愿自己有能力爱你';
            con3.value='世界这么大，而我真正想落脚的地方，是你的身旁。刚才我向星星许了愿，星星说，我们的故事会永远流传，写成远古的绝版，在爱的石壁上，每一笔都不可圈点。水晶之恋，爱你一生不变！';
            con4.value='http://t.448521.com/?bhx';
