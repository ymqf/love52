...
<meta name="description" content="<?php echo htmlspecialchars(urldecode($title)); ?>是一款全自动在线网页制作工具，圣诞祝福网页,国内顶尖自动化网页制作系统，只需选择模板一键生成即可。可制作一系列个人网页、表白网页、HTML5网页等等，人人都能做网页。" />
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=ETZN4uy" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con1.value='圣诞祝福网页';
            con2.value='http://h5.448521.com/biaobai_shengdan/picture/tx.jpg';
            con3.value='圣诞节快乐';
            con4.value='祝你享尽圣诞佳节的快乐和圣诞的礼品。';
			con5.value='710302655';
			con6.value='http://t.448521.com/?rzdx';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
