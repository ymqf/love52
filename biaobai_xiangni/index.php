...
<title>想你表白_<?php echo htmlspecialchars(urldecode($title)); ?></title>
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">好想你表白页面</h2>
            <h3 class="animate-box"><a href="../web.php?id=iMy77hq" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
			...
			con1.value='丹丹我爱你❤';
            con2.value='不知道有多爱你，只知道早上想你，中午想你，晚上想你，每个梦里都是你，一有时间就想见到你……';
