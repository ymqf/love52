...
<title>两句话表白_<?php echo htmlspecialchars(urldecode($title)); ?></title>
 ...
 <section id="fh5co-hero" class="no-js-fullheight" style="background-image: url(../images/nav-biaobai.jpg);" data-next="yes">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">两句话表白</h2>
            <h3 class="animate-box"><a href="../web.php?id=gs2NKvH" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con1" name="con1" type="text" class="form-control" placeholder="请输入第一句话">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con2" name="con2" type="text" class="form-control" placeholder="请输入第二句话">
        </div>
      </div>
	  ...
	  <div class="col-md-12">
        <div class="form-group">
          <div id="fh5co-subscribe">
            <input id="con3" name="con3" type="text" class="form-control" placeholder="请输入图片URL地址一">
	  ...
	  <div class="col-md-12">
        <div class="form-group">
          <div id="fh5co-subscribe">
            <input id="con4" name="con4" type="text" class="form-control" placeholder="请输入图片URL地址二">
            <input type="button" value="上传图片" class="btn btn-primary" onclick="window.open('../tupian.php','_blank')">
          </div>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <div id="fh5co-subscribe">
            <input id="con5" name="con5" type="text" class="form-control" placeholder="请输入图片URL地址三">
            <input type="button" value="上传图片" class="btn btn-primary" onclick="window.open('../tupian.php','_blank')">
          </div>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <div id="fh5co-subscribe">
            <input id="con6" name="con6" type="text" class="form-control" placeholder="请输入图片URL地址四">
            <input type="button" value="上传图片" class="btn btn-primary" onclick="window.open('../tupian.php','_blank')">
          </div>
        </div>
      </div>
	...
	<script>
        function shuru(){
            ...
            con1.value='可能是我上辈子做了很多的好事';
            con2.value='让我这辈子遇到你这么好的女孩';
            con3.value='https://icon.qiantucdn.com/20191012/b00f59fe0d0941e9915b4a82237e8f872';
            con4.value='https://icon.qiantucdn.com/20191012/242f126cdcda3c621b8b7e2dab9078a42';
			con5.value='https://icon.qiantucdn.com/20191012/c3d69bc8ffa6bdbd5638b9eff9a5dd672';
			con6.value='https://icon.qiantucdn.com/20191012/393f7e1c506529bc25f9045fcaa840f32';
			con7.value='http://t.hunlipic.com/?qfdy';
