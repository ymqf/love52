...
<title>画心简单表白_<?php echo htmlspecialchars(urldecode($title)); ?></title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="<?php echo htmlspecialchars(urldecode($title)); ?>简单的画心表白，成功率更高一些。" />
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">女神名字画心</h2>
            <h3 class="animate-box"><a href="../web.php?id=Zlfm0L4" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con1" name="con1" type="text" class="form-control" placeholder="填写女神名字">
        </div>
      </div>
